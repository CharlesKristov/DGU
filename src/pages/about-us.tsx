    ...
    return (
        <>
            <div className="flex flex-col items-center m-3">
                ...
                <div className="mt-3 text-lg leading-6 text-black text-justify mx-auto w-[75%] max-md:w-full">
                ...
                <div className="mt-1.5 text-lg leading-6 text-black text-center mx-auto w-[75%] max-md:w-full italic">
                    Marketing & Service Center in MGK Kemayoran Jakarta
                </div>
                <div className="mt-14 text-lg leading-6 text-black text-justify mx-auto w-[75%] max-md:w-full">
                ...
                <div className="mt-5 text-lg leading-6 text-black text-justify mx-auto w-[75%] max-md:w-full">
                ...
                <div className="mt-5 text-center text-3xl font-semibold mb-4 text-primary-blue mx-auto w-[75%] max-md:w-full">
                    Our Group of Companies
                    <Image src={OrgChart} alt="OrgChart" className="mt-5"/>
                </div>
                <div className="mt-10 w-full w-[75%] max-md:w-full mx-auto">
                    <div>

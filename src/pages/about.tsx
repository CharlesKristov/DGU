    ...
    return (
        <>
            <div className="flex flex-col items-center m-3">
                <h1 className="mt-10 text-3xl font-bold leading-10 text-primary-blue text-center">
                    Company Profile
                </h1>
                <div className="mt-3 text-lg leading-6 text-black text-justify mx-auto max-w-[900px] max-md:max-w-full">
                ...
                <div className="mt-5 max-w-[900px] max-md:max-w-full">
                    <Image src={MGK} alt="MGK" />
                </div>
                <div className="mt-1.5 text-lg leading-6 text-black text-center mx-auto max-w-[900px] max-md:max-w-full italic">
                    Marketing & Service Center in MGK Kemayoran Jakarta
                </div>
                <div className="mt-14 text-lg leading-6 text-black text-justify mx-auto max-w-[900px] max-md:max-w-full">
                ...
                <div className="mt-5 text-lg leading-6 text-black text-justify mx-auto max-w-[900px] max-md:max-w-full">
                ...
                <div className="mt-5 text-center text-3xl font-semibold mb-4 text-primary-blue mx-auto max-w-[900px] max-md:max-w-full">
                    Our Group of Companies
                    <Image src={OrgChart} alt="OrgChart" className="mt-5"/>
                </div>
                <div className="mt-10 w-full max-w-[900px] max-md:max-w-full mx-auto">
                    <div>

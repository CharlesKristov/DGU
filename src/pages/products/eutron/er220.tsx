...
export default function ER220s() {
    return (
        <div className="min-h-screen bg-gradient-to-b py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                <header className="text-center mb-12">
                    <h1 className="text-4xl font-bold text-primary-blue mb-2">ER220</h1>
                </header>
                ...
                <div className="grid md:grid-cols-2 gap-8 items-start mb-12">
                    ...
                    <div className="space-y-6">
                        <h2 className="text-2xl font-semibold text-black">What is ER220?</h2>

...
export default function BPLUSC2() {
    return (
        <div className="min-h-screen bg-gradient-to-b py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                <header className="text-center mb-12">
                    <h1 className="text-4xl font-bold text-primary-blue mb-2">bPlus C2</h1>
                </header>
                ...
                <div className="grid md:grid-cols-2 gap-8 items-start mb-12">
                    ...
                    <div className="space-y-6">
                        <h2 className="text-2xl font-semibold text-black">What is bPlus C2?</h2>
                        ...
                        <Link href="/MT/bPlus_C2_Bench.pdf" rel="noopener noreferrer" target="_blank">
